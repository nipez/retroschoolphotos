...
- Public yearbook (opt-in): Pages Functions under `functions/` + R2 binding `YEARBOOK` → private bucket `retro-yearbook`. Images served only via `/api/yearbook/:id` (not public r2.dev).
